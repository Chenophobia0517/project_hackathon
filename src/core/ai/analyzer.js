...
(function (global) {
  ...
  var SYSTEM_PROMPTS = {
    truth: [
      ...
      '4. evidences 给出 1~4 条支持或反驳的证据，注明来源类型（原始研究/官方资料/权威报告/专业媒体/社区讨论）。无法给出可靠来源时留空数组。',
      '5. comparison 必须诚实对照"原文说了什么"与"来源实际表达了什么"，指出是否把相关性夸大为因果、绝对化、以偏概全等。没有可靠来源时 comparison 为 null。',
    ...
    deep: [
      ...
      '2. concepts：3~6 个关键概念节点，每个附一句话简介。',
      '3. tree：围绕 Claim 的知识树，root 是核心概念，branches 分 2~4 个维度（如 原理/应用/争议），每支挂 2~4 个具体节点。',
    ...
    differ: [
      ...
      '2. viewpoints：2~4 个不同立场，stance 用中文短语（如 乐观派/谨慎派/怀疑派），point 是核心论点，reason 是主要理由。立场必须有实质差异，不是同义反复。',
      '3. blindSpots：1~4 个当前内容较少讨论但重要的维度（认知盲区），每个说明 why。',
